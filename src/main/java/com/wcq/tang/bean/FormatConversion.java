...
public class FormatConversion {
    private final static Logger logger = LoggerFactory.getLogger(FormatConversion.class);
    /**
     * Excel转txt接口
     * @param filePath
     * @return
    ...
    public static String pdfToTxt(String filePath){
        ...
        try {
            ...
            //打开文件输出流
            outputStreamWriter = new OutputStreamWriter(new FileOutputStream(txtPath), "UTF-8");
